        ...
        if (command == "add") {
            ...
            if (argc > 2) {
                ...
                if (filter == "pending") {
                    ...
                    std::cerr << "Error: Unknown filter '" << filter << "'. Use 'pending' or 'completed'.\n";
                    return 1;
                }
            } else {
                manager.PrintTasks();
            ...
            try {
                ...
                std::cerr << "Error: Invalid index '" << argv[2] << "'. Please provide a valid number.\n";
                return 1;
            ...
            if (config_command == "path") {
                ...
                std::cerr << "Error: Unknown config command '" << config_command << "'. Use 'path' or 'name'.\n";
                return 1;
            }
        }
            ...
            std::cerr << "Error: Unknown command '" << command << "'. Use 'help' to see available commands.\n";
            return 1;
        }
